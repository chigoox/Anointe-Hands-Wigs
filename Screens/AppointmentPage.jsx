...
export default function AppointmentPage(){
    ...
    const [selectedDate, setSelectedDate] =  useState('05-05-2025')
...
if (appointmentData) console.log(Object.keys(appointmentData))
const isFocused = useIsFocused()



const _markedDates = () =>{ (Object.keys(appointmentData)).forEach((item)=>{
     setMarkedDates((old) => {
