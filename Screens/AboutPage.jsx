...
export default function AboutPage() {
  return (
    <Animated.ScrollView className={'flex-1 h-screen w-screen'} entering={FadeInDown} exiting={ZoomOutEasyDown} contentInsetAdjustmentBehavior="automatic">
      <SafeAreaView className={'flex flex-1 h-full '}>
        ...
        <View className={'h-fit p-4 overflow-hidden w-fit flex flex-row rounded-2xl m-auto'}>
          <View className={''}>
            <Image className={'rounded-3xl h-[400px] w-full object-contain scale-75 top-22 top-[10%]'} source={require('../assets/Temp.png')}></Image>
