...
sgMail.setApiKey('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') //(process.env.SENDGRID_API_KEY)
...
function SendSMS(number, txt){
  const accountSid = 'ACbe9bf767831def2a48f2248159f21063'//process.env.TWILIO_ACCOUNT_SID;
  const authToken = '282e78a16c0df0f1cf73acbf4bdab09d'//process.env.TWILIO_AUTH_TOKEN;
